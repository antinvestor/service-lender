...
require (
	...
	buf.build/gen/go/antinvestor/identity/connectrpc/go v1.19.1-20260414182058-6e4feef8d27f.2
	buf.build/gen/go/antinvestor/identity/protocolbuffers/go v1.36.11-20260414182058-6e4feef8d27f.1
