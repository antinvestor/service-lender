...
require (
	...
	buf.build/gen/go/antinvestor/limits/connectrpc/go v1.19.2-20260506053608-8e6644c0ee6e.1
	buf.build/gen/go/antinvestor/limits/protocolbuffers/go v1.36.11-20260506053608-8e6644c0ee6e.1
