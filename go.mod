...
require (
	...
	buf.build/gen/go/antinvestor/savings/connectrpc/go v1.19.1-20260409094821-b39fad2e08d4.2
	buf.build/gen/go/antinvestor/savings/protocolbuffers/go v1.36.11-20260409094821-b39fad2e08d4.1
