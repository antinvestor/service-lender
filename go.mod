...
require (
	...
	buf.build/gen/go/antinvestor/identity/connectrpc/go v1.19.1-20260413210636-3fe2c627a767.2
	buf.build/gen/go/antinvestor/identity/protocolbuffers/go v1.36.11-20260413210636-3fe2c627a767.1
