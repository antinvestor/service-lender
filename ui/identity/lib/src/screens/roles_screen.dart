...
const _entityColumns = <(_Entity, List<_Action>)>[
  ...
  (
    _Entity.workforceMember,
    [_Action.create, _Action.manage, _Action.view],
  ),
  (
    _Entity.client,
        ...
        return CustomScrollView(
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                padding:
                    EdgeInsets.fromLTRB(padding, padding, padding, 8),
                child: Column(
            ...
            SliverToBoxAdapter(
              child: Padding(
                padding:
                    EdgeInsets.fromLTRB(padding, 12, padding, 4),
                child: Row(
                  children: [
                    Icon(Icons.check,
...
class _PermissionTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Table(
      ...
      children: [
        _buildEntityGroupRow(colorScheme),
  ...
  TableRow _buildEntityGroupRow(ColorScheme colorScheme) {
    final cells = <Widget>[
      Container(
  ...
  TableRow _buildDataRow(
    ...
    for (final (entity, actions) in _entityColumns) {
      for (final action in actions) {
        final hasPermission =
            granted.contains(_Permission(entity, action));
        cells.add(
          Container(
            padding: const EdgeInsets.symmetric(
                vertical: 8, horizontal: 8),
