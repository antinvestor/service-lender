...
class LoanProductType extends $pb.ProtobufEnum {
  static const LoanProductType LOAN_PRODUCT_TYPE_UNSPECIFIED =
      LoanProductType._(
          0, _omitEnumNames ? '' : 'LOAN_PRODUCT_TYPE_UNSPECIFIED');
  static const LoanProductType LOAN_PRODUCT_TYPE_TERM =
      LoanProductType._(1, _omitEnumNames ? '' : 'LOAN_PRODUCT_TYPE_TERM');
  static const LoanProductType LOAN_PRODUCT_TYPE_REVOLVING =
      LoanProductType._(2, _omitEnumNames ? '' : 'LOAN_PRODUCT_TYPE_REVOLVING');
  static const LoanProductType LOAN_PRODUCT_TYPE_BULLET =
      LoanProductType._(3, _omitEnumNames ? '' : 'LOAN_PRODUCT_TYPE_BULLET');
  static const LoanProductType LOAN_PRODUCT_TYPE_GRADUATED =
      LoanProductType._(4, _omitEnumNames ? '' : 'LOAN_PRODUCT_TYPE_GRADUATED');
  ...
  static final $core.Map<$core.int, LoanProductType> _byValue =
...
class ApplicationStatus extends $pb.ProtobufEnum {
  static const ApplicationStatus APPLICATION_STATUS_UNSPECIFIED =
      ApplicationStatus._(
          0, _omitEnumNames ? '' : 'APPLICATION_STATUS_UNSPECIFIED');
  static const ApplicationStatus APPLICATION_STATUS_DRAFT =
      ApplicationStatus._(1, _omitEnumNames ? '' : 'APPLICATION_STATUS_DRAFT');
  static const ApplicationStatus APPLICATION_STATUS_SUBMITTED =
      ApplicationStatus._(
          2, _omitEnumNames ? '' : 'APPLICATION_STATUS_SUBMITTED');
  static const ApplicationStatus APPLICATION_STATUS_KYC_PENDING =
      ApplicationStatus._(
          3, _omitEnumNames ? '' : 'APPLICATION_STATUS_KYC_PENDING');
  static const ApplicationStatus APPLICATION_STATUS_DOCUMENTS_PENDING =
      ApplicationStatus._(
          4, _omitEnumNames ? '' : 'APPLICATION_STATUS_DOCUMENTS_PENDING');
  static const ApplicationStatus APPLICATION_STATUS_VERIFICATION =
      ApplicationStatus._(
          5, _omitEnumNames ? '' : 'APPLICATION_STATUS_VERIFICATION');
  static const ApplicationStatus APPLICATION_STATUS_UNDERWRITING =
      ApplicationStatus._(
          6, _omitEnumNames ? '' : 'APPLICATION_STATUS_UNDERWRITING');
  static const ApplicationStatus APPLICATION_STATUS_APPROVED =
      ApplicationStatus._(
          7, _omitEnumNames ? '' : 'APPLICATION_STATUS_APPROVED');
  static const ApplicationStatus APPLICATION_STATUS_REJECTED =
      ApplicationStatus._(
          8, _omitEnumNames ? '' : 'APPLICATION_STATUS_REJECTED');
  static const ApplicationStatus APPLICATION_STATUS_OFFER_GENERATED =
      ApplicationStatus._(
          9, _omitEnumNames ? '' : 'APPLICATION_STATUS_OFFER_GENERATED');
  static const ApplicationStatus APPLICATION_STATUS_OFFER_ACCEPTED =
      ApplicationStatus._(
          10, _omitEnumNames ? '' : 'APPLICATION_STATUS_OFFER_ACCEPTED');
  static const ApplicationStatus APPLICATION_STATUS_OFFER_DECLINED =
      ApplicationStatus._(
          11, _omitEnumNames ? '' : 'APPLICATION_STATUS_OFFER_DECLINED');
  static const ApplicationStatus APPLICATION_STATUS_LOAN_CREATED =
      ApplicationStatus._(
          12, _omitEnumNames ? '' : 'APPLICATION_STATUS_LOAN_CREATED');
  static const ApplicationStatus APPLICATION_STATUS_CANCELLED =
      ApplicationStatus._(
          13, _omitEnumNames ? '' : 'APPLICATION_STATUS_CANCELLED');
  static const ApplicationStatus APPLICATION_STATUS_EXPIRED =
      ApplicationStatus._(
          14, _omitEnumNames ? '' : 'APPLICATION_STATUS_EXPIRED');
  ...
  static final $core.Map<$core.int, ApplicationStatus> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class DocumentType extends $pb.ProtobufEnum {
  static const DocumentType DOCUMENT_TYPE_UNSPECIFIED =
      DocumentType._(0, _omitEnumNames ? '' : 'DOCUMENT_TYPE_UNSPECIFIED');
  static const DocumentType DOCUMENT_TYPE_NATIONAL_ID =
      DocumentType._(1, _omitEnumNames ? '' : 'DOCUMENT_TYPE_NATIONAL_ID');
  static const DocumentType DOCUMENT_TYPE_PASSPORT =
      DocumentType._(2, _omitEnumNames ? '' : 'DOCUMENT_TYPE_PASSPORT');
  static const DocumentType DOCUMENT_TYPE_BUSINESS_REGISTRATION =
      DocumentType._(
          3, _omitEnumNames ? '' : 'DOCUMENT_TYPE_BUSINESS_REGISTRATION');
  static const DocumentType DOCUMENT_TYPE_BANK_STATEMENT =
      DocumentType._(4, _omitEnumNames ? '' : 'DOCUMENT_TYPE_BANK_STATEMENT');
  static const DocumentType DOCUMENT_TYPE_TAX_CERTIFICATE =
      DocumentType._(5, _omitEnumNames ? '' : 'DOCUMENT_TYPE_TAX_CERTIFICATE');
  static const DocumentType DOCUMENT_TYPE_PROOF_OF_ADDRESS =
      DocumentType._(6, _omitEnumNames ? '' : 'DOCUMENT_TYPE_PROOF_OF_ADDRESS');
  static const DocumentType DOCUMENT_TYPE_INCOME_PROOF =
      DocumentType._(7, _omitEnumNames ? '' : 'DOCUMENT_TYPE_INCOME_PROOF');
  static const DocumentType DOCUMENT_TYPE_COLLATERAL_PHOTO =
      DocumentType._(8, _omitEnumNames ? '' : 'DOCUMENT_TYPE_COLLATERAL_PHOTO');
  static const DocumentType DOCUMENT_TYPE_OTHER =
      DocumentType._(99, _omitEnumNames ? '' : 'DOCUMENT_TYPE_OTHER');
  ...
  static final $core.Map<$core.int, DocumentType> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class VerificationStatus extends $pb.ProtobufEnum {
  ...
  static const VerificationStatus VERIFICATION_STATUS_IN_PROGRESS =
      VerificationStatus._(
          2, _omitEnumNames ? '' : 'VERIFICATION_STATUS_IN_PROGRESS');
  static const VerificationStatus VERIFICATION_STATUS_PASSED =
      VerificationStatus._(
          3, _omitEnumNames ? '' : 'VERIFICATION_STATUS_PASSED');
  static const VerificationStatus VERIFICATION_STATUS_FAILED =
      VerificationStatus._(
          4, _omitEnumNames ? '' : 'VERIFICATION_STATUS_FAILED');
  static const VerificationStatus VERIFICATION_STATUS_NEEDS_REVIEW =
      VerificationStatus._(
          5, _omitEnumNames ? '' : 'VERIFICATION_STATUS_NEEDS_REVIEW');
...
class UnderwritingOutcome extends $pb.ProtobufEnum {
  static const UnderwritingOutcome UNDERWRITING_OUTCOME_UNSPECIFIED =
      UnderwritingOutcome._(
          0, _omitEnumNames ? '' : 'UNDERWRITING_OUTCOME_UNSPECIFIED');
  static const UnderwritingOutcome UNDERWRITING_OUTCOME_APPROVE =
      UnderwritingOutcome._(
          1, _omitEnumNames ? '' : 'UNDERWRITING_OUTCOME_APPROVE');
  static const UnderwritingOutcome UNDERWRITING_OUTCOME_REJECT =
      UnderwritingOutcome._(
          2, _omitEnumNames ? '' : 'UNDERWRITING_OUTCOME_REJECT');
  static const UnderwritingOutcome UNDERWRITING_OUTCOME_REFER =
      UnderwritingOutcome._(
          3, _omitEnumNames ? '' : 'UNDERWRITING_OUTCOME_REFER');
  static const UnderwritingOutcome UNDERWRITING_OUTCOME_COUNTER_OFFER =
      UnderwritingOutcome._(
          4, _omitEnumNames ? '' : 'UNDERWRITING_OUTCOME_COUNTER_OFFER');
  ...
  static final $core.Map<$core.int, UnderwritingOutcome> _byValue =
      $pb.ProtobufEnum.initByValue(values);
