...
class Annotations {
  static final document = $pb.Extension<$5.Document>(
      _omitMessageNames ? '' : 'google.protobuf.FileOptions',
      _omitFieldNames ? '' : 'document',
      1143,
      $pb.PbFieldType.OM,
      defaultOrMaker: $5.Document.getDefault,
      subBuilder: $5.Document.create);
  static final operation = $pb.Extension<$5.Operation>(
      _omitMessageNames ? '' : 'google.protobuf.MethodOptions',
      _omitFieldNames ? '' : 'operation',
      1143,
      $pb.PbFieldType.OM,
      defaultOrMaker: $5.Operation.getDefault,
      subBuilder: $5.Operation.create);
  static final schema = $pb.Extension<$5.Schema>(
      _omitMessageNames ? '' : 'google.protobuf.MessageOptions',
      _omitFieldNames ? '' : 'schema',
      1143,
      $pb.PbFieldType.OM,
      defaultOrMaker: $5.Schema.getDefault,
      subBuilder: $5.Schema.create);
  static final property = $pb.Extension<$5.Schema>(
